...
var MenuRoot = forwardRefWithAs(function Menu(props, ref) {
  ...
  let menuContextValue = (0, import_react31.useMemo)(() => [{ ...reducerState, menuState }, dispatch], [menuState, reducerState, dispatch]);
  let theirProps = props;
